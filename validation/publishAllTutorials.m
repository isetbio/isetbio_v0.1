function publishAllTutorials
    ...
    p = struct(...
        ...
        'tutorialsDir',    fullfile(isetbioRootPath, 'tutorials'), ...                % local directory where tutorial scripts are located
...
function publishProject(p, scriptsToSkip)
    ...
    tutorialsHTMLdir = fullfile(ghPagesCloneDir, tutorialsHTMLsubdir);
    ...
    fprintf(tutorialsCatalogFileFID,'***\n_This file is autogenerated by the ''pulishAllTutorials'' script. Do not edit manually, as all changes will be overwritten during the next run._\n***');
