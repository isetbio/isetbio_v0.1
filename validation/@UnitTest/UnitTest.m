classdef UnitTest < handle
    ...
    properties (Constant) 
        ...
        validationOptionDefaultValues   = {'RUNTIME_ERRORS_ONLY', ...
                                           ...
                                           500*eps, ...
                                           true,  ...
                                           fullfile(filesep,'Users', 'Shared', 'Matlab', 'Toolboxes', 'isetbio', 'validation', filesep), ...
                                           fullfile(filesep,'Users', 'Shared', 'Matlab', 'Toolboxes', 'ISETBIO_Wiki', 'isetbio.wiki', filesep), ...
                                           fullfile(filesep,'Users', 'Shared', 'Matlab', 'Toolboxes', 'ISETBIO_GhPages', 'isetbio', filesep), ...
