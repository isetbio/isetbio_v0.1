...
% - conduct a validationSession with different modes
    ...
    if (validateAllDirs)
        ...
        vScriptsList = {...
            {fullfile('validationscripts', 'color', filesep)} ... 
            {fullfile('validationscripts', 'cones', filesep)} ... 
            {fullfile('validationscripts', 'human', filesep)} ... 
            {fullfile('validationscripts', 'optics', filesep)} ... 
            {fullfile('validationscripts', 'radiometry', filesep)} ... 
            {fullfile('validationscripts', 'scene', filesep)} ... 
            {fullfile('validationscripts', 'codedevscripts', filesep), struct('generatePlots', true) } ...
        };
    else
