...
%Convert DAC values through a gamma table to linear RGB intensities
%
...
elseif (prod(size(GammaTable))==3)
    ...
    % A table was sent in.  We put the RGB values in the dac through three
    % different lookup tables, one for the R,G and B.
