...
% There are many ways to create scenes.  To create a simple spectral scene
% of a Macbeth Chart  under a D65 illuminant, we use 
sceneMacbethD65 = sceneCreate('macbethd65');

% To place the scene data in the window, add the scene object to the
% session and select it. 
vcAddAndSelectObject('scene',sceneMacbethD65);

% Then bring up the scene window.  You can interact with the scene through
% this window
sceneWindow;
